...
class CatalogDatabaseBuilder extends CatalogController
{
    ...
    protected array $arrColumn = [];

    protected array $arrCatalog = [];

    protected $strTablename = null;

    protected bool $blnCoreTable = false;

    protected array $arrPermissionColumns = [];

    protected array $arrTableColumns = [
    ...
    public function initialize($strTablename, $arrCatalog = null): void
    {
    ...
    public function setColumn($arrColumn): void
    {
    ...
    protected function hasOperator($strOperator): bool
    {
    ...
    protected function checkDependencies($strNewTable)
    {
        ...
        if ($objCatalogs->numRows) {
            ...
            while ($objCatalogs->next()) {
                ...
                $arrCTables = StringUtil::deserialize($arrCatalog['cTables'], true);
