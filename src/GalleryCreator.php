...
class GalleryCreator extends Frontend
{
    ...
    protected array $arrPreviewImage = [];
    ...
    public function render()
    {
        ...
        while ($this->objFiles->next()) {
            ...
            if (isset($arrImages[$this->objFiles->path]) || !file_exists($strRootDir . '/' . $this->objFiles->path)) {
                continue;
            }
        ...
        $intMaxWidth = (System::getContainer()->get('contao.routing.scope_matcher')->isBackendRequest(System::getContainer()->get('request_stack')->getCurrentRequest() ?? Request::create(''))) ? floor((640 / $this->perRow)) : floor((Config::get('maxImageWidth') / $this->perRow));
