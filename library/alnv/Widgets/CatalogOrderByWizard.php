        ...
        $return = '<table class="tl_optionwizard" id="ctrl_'.$this->strId.'">
              ...
              <tbody class="sortable" data-tabindex="'.$tabindex.'">';
                    ...
                    for ($i=0, $c=count($this->varValue); $i<$c; $i++) {
                        $return .= '
                        <tr>
                          <td><select name="'.$this->strId.'['.$i.'][key]" id="'.$this->strId.'_key_'.$i.'" class="tl_select tl_chosen">' . $this->generateSelectOptions( $arrFieldOptions, 'key', $i ) . '</select></td>
                          <td><select name="'.$this->strId.'['.$i.'][value]" id="'.$this->strId.'_value_'.$i.'" class="tl_select tl_chosen">' . $this->generateSelectOptions( $arrOrderByOptions, 'value', $i ) . '</select></td>';
