...
class CatalogTaxonomyWizard extends Widget
{
    ...
    private array $arrFields = [];

    private array $arrTaxonomies = [];
        ...
        switch ($arrQuery['operator']) {
            ...
            default:
                ...
                if (is_array($arrQuery['value'])) {
                    $arrQuery['value'] = $arrQuery['value'][0] ?: '';
                }
    ...
    protected function getSelectOptions($strField, $arrValues): string
    {
    ...
    protected function getOperatorOptions($arrQuery): string
    {
