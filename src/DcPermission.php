                    ...
                    if (is_array($arrNew[$strTable]) && in_array($strID, $arrNew[$strTable])) {
                        ...
                        if ($this->User->inherit != 'custom') {
                            ...
                            while ($objGroup->next()) {
                                ...
                                $arrPermissions = StringUtil::deserialize($objGroup->{$strFieldPermissions}, true);

                                if (is_array($arrPermissions) && in_array('create', $arrPermissions)) {

                                    $arrFields = StringUtil::deserialize($objGroup->{$strFieldname}, true);
                        ...
                        if ($this->User->inherit != 'group') {
                            ...
                            $arrPermissions = StringUtil::deserialize($objUser->{$strFieldPermissions});

                            if (is_array($arrPermissions) && in_array('create', $arrPermissions)) {

                                $arrFields = StringUtil::deserialize($objUser->{$strFieldname}, true);
