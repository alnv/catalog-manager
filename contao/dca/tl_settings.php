...
$GLOBALS['TL_DCA']['tl_settings']['config']['onload_callback'] = [
    ['CatalogManager\classes\tl_settings', 'changeGlobals']
];
...
$GLOBALS['TL_DCA']['tl_settings']['fields']['catalogLicence'] = [
    ...
    'save_callback' => [['CatalogManager\classes\tl_settings', 'verifyLicence']]
];
$GLOBALS['TL_DCA']['tl_settings']['fields']['catalogNavigationAreas'] = [
    ...
    'save_callback' => [['CatalogManager\classes\tl_settings', 'parseNavigationName']]
];
