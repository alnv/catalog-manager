...
$GLOBALS['TL_LANG']['MSC']['CATALOG_MANAGER']['submit'] = 'Save';
$GLOBALS['TL_LANG']['MSC']['CATALOG_MANAGER']['back'] = 'Go back';
...
$GLOBALS['TL_LANG']['MSC']['CATALOG_MANAGER']['next'] = 'Go to the next article';
