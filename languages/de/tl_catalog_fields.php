...
$GLOBALS['TL_LANG']['tl_catalog_fields']['textareaRows'] = [ 'Zeilen', 'Bitte geben Sie die Anzahl an Zeilen ein.' ];
$GLOBALS['TL_LANG']['tl_catalog_fields']['placeholder'] = [ 'Platzhalter', 'Bitte geben Sie einen Platzhalter ein.' ];
$GLOBALS['TL_LANG']['tl_catalog_fields']['textareaCols'] = [ 'Spalten', 'Bitte geben Sie die Anzahl an Spalten ein.' ];
...
$GLOBALS['TL_LANG']['tl_catalog_fields']['mapPrivacyText'] = [ 'Datenschutzhinweis', 'Hier können Sie Ihre Datenschutzerklärung hinzufügen.' ];
$GLOBALS['TL_LANG']['tl_catalog_fields']['mapProtected'] = [ 'Datenschutz-Bestätigung', 'Hier können Sie eine Datenschutz-Bestätigung hinzufügen.' ];
