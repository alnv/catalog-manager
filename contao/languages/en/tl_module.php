...
$GLOBALS['TL_LANG']['tl_module']['catalogResetFilterForm'] = ['Add reset button to form', 'Allow to reset form filter in Frontend. Only with GET Submission method possible.'];
...
$GLOBALS['TL_LANG']['tl_module']['catalogNotifyInsert'] = ['Notifications [duplicate]', 'Manage notifications.'];
...
$GLOBALS['TL_LANG']['tl_module']['catalogPdfOrientation'] = ['Page orientation', 'Please select your page orientation.'];
