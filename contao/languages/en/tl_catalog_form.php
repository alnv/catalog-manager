...
$GLOBALS['TL_LANG']['tl_catalog_form']['edit'] = [ 'Edit filter form', 'Edit filter form ID "%s".' ];
$GLOBALS['TL_LANG']['tl_catalog_form']['copy'] = [ 'Copy filter form', 'Copy filter form ID "%s".' ];
$GLOBALS['TL_LANG']['tl_catalog_form']['delete'] = [ 'Delete filter form', 'Delete filter form ID "%s".' ];
$GLOBALS['TL_LANG']['tl_catalog_form']['show'] = [ 'Show details', 'Show the details of filter form ID "%s".' ];
...
$GLOBALS['TL_LANG']['tl_catalog_form']['attributes'] = [ 'CSS ID/class [Formular]', 'Here you can set an ID and one or more classes.' ];
$GLOBALS['TL_LANG']['tl_catalog_form']['disableHtml5Validation'] = [ 'Disable HTML5 validation', 'Add the novalidate attribute to the form tag.' ];
