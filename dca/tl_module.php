...
$GLOBALS['TL_DCA']['tl_module']['fields']['catalogFilterChangeOnSubmit'] = [

    'label' => &$GLOBALS['TL_LANG']['tl_module']['catalogFilterChangeOnSubmit'],
    'inputType' => 'checkbox',
